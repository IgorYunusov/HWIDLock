...
string checkhash = "06e941131eede7760d1bb3fba76b1191aa5e5cf471a97334a93a10c4452e1e10"; // Alqohol's Hash
string userhash;
...
bool CheckHash(string& userhash)
{
	if (checkhash.compare(userhash) == 0) { cout << "Matches" << endl; }
	else
	{
...
string GetIP()
{
	...
	TCHAR url[] = TEXT("http://myexternalip.com/raw");
